// app/organiser/event/[title]/page.tsx
"use client";
...
export default function EventDetailPage() {
    const { title } = useParams(); // Dynamic route param
        ...
        const fetchEvent = async () => {
            try {
                const response = await axios.get(
                    `https://fest-event-app-backend.onrender.com/api/events/title/${title}`
                );
    ...
    return (
        ...
        <div className="min-h-screen bg-gradient-to-r from-blue-900 via-black to-gray-900 p-5 text-white w-screen">
            ...
            <div className="min-h-screen bg-black text-white p-6">
                ...
                <img src={event.imageUrl} alt={event.title} className="w-full h-300 object-cover rounded-lg mb-4" />
